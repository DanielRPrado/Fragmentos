...
class IMC : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_i_m_c, container, false)

        val irInicio = view.findViewById<Button>(R.id.irInicio)

        irInicio.setOnClickListener {
            (activity as MainActivity).replaceFragmento(Inicio())
        }
